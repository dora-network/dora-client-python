...
class CurrentLeverageAccruedInterestResponseEnvelope(BaseModel):
    """
    CurrentLeverageAccruedInterestResponseEnvelope
    """ # noqa: E501
    data: Optional[CurrentLeverageAccruedInterest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CurrentLeverageAccruedInterest.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
