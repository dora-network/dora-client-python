...
class ReviewTradingChallengeRegistrationRequest(BaseModel):
    """
    Body of approve and reject. Optional: an empty body is accepted.
    """ # noqa: E501
    reason: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Free-text note kept for the audit trail.")
