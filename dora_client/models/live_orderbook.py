...
class LiveOrderbook(BaseModel):
    """
    LiveOrderbook
    """ # noqa: E501
    bids: List[PriceLevel] = Field(description="sorted in desc order by price")
    asks: List[PriceLevel] = Field(description="sorted in asc order by price")
