...
class StreamUserCouponPaymentsEntry(BaseModel):
    """
    StreamUserCouponPaymentsEntry
    """ # noqa: E501
    val: UserCouponPayment = Field(alias="Val")
    time: datetime = Field(description="The timestamp when the data was created", alias="Time")
    __properties: ClassVar[List[str]] = ["Val", "Time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Val": UserCouponPayment.from_dict(obj["Val"]) if obj.get("Val") is not None else None,
            "Time": obj.get("Time")
        })
        return _obj
