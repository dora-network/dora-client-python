...
class UpdateRolesString(object):
    ...
    def __init__(self, update=None, value=None):  # noqa: E501
        """UpdateRolesString - a model defined in Swagger"""  # noqa: E501
        self._update = None
        self._value = None
    ...
    @property
    def update(self):
        """Gets the update of this UpdateRolesString.  # noqa: E501
    ...
    def update(self, update):
        """Sets the update of this UpdateRolesString.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateRolesString, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRolesString):
            return False
