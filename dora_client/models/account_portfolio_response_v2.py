...
class AccountPortfolioResponseV2(BaseModel):
    """
    AccountPortfolioResponseV2
    """ # noqa: E501
    portfolio: Optional[AccountPortfolioV2] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "portfolio": AccountPortfolioV2.from_dict(obj["portfolio"]) if obj.get("portfolio") is not None else None
        })
        return _obj
