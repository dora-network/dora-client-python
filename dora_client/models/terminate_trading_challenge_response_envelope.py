...
class TerminateTradingChallengeResponseEnvelope(BaseModel):
    """
    TerminateTradingChallengeResponseEnvelope
    """ # noqa: E501
    data: Optional[TerminateTradingChallengeResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TerminateTradingChallengeResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
