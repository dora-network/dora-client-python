...
class TransferAccountBalancesResponseEnvelope(BaseModel):
    """
    TransferAccountBalancesResponseEnvelope
    """ # noqa: E501
    data: Optional[AccountBalanceTransfer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AccountBalanceTransfer.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
