...
class ListAccountsResponseV2Envelope(BaseModel):
    """
    ListAccountsResponseV2Envelope
    """ # noqa: E501
    data: Optional[List[AccountSummaryV2]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AccountSummaryV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
