...
class TransactionsSettlementsResponse(BaseModel):
    """
    TransactionsSettlementsResponse
    """ # noqa: E501
    settlements: Optional[List[TransactionsSettlement]] = None
    user_totals: Optional[Dict[str, StrictStr]] = None
    tenant_totals: Optional[Dict[str, StrictStr]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settlements": [TransactionsSettlement.from_dict(_item) for _item in obj["settlements"]] if obj.get("settlements") is not None else None,
