...
class NewIsolatedAccountRequestV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["global_account_id", "asset_id", "quantity", "account_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "global_account_id": obj.get("global_account_id"),
