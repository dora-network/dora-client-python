...
class AffiliateCashFlowReportEnvelope(BaseModel):
    """
    AffiliateCashFlowReportEnvelope
    """ # noqa: E501
    data: AffiliateCashFlowReport
    metadata: Metadata
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AffiliateCashFlowReport.from_dict(obj["data"]) if obj.get("data") is not None else None,
