...
class HistoricalLeverageInterestRates(BaseModel):
    """
    ...
    start_time: datetime
    end_time: datetime
    rates: List[HistoricalLeverageInterestRate]
    __properties: ClassVar[List[str]] = ["asset_id", "start_time", "end_time", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [HistoricalLeverageInterestRate.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
