...
class StreamOrderBookBalanceEntry(BaseModel):
    """
    StreamOrderBookBalanceEntry
    """ # noqa: E501
    val: OrderBookBalance = Field(alias="Val")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Val": OrderBookBalance.from_dict(obj["Val"]) if obj.get("Val") is not None else None,
            "Time": obj.get("Time")
        })
        return _obj
