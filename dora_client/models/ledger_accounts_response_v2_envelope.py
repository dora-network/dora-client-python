...
class LedgerAccountsResponseV2Envelope(BaseModel):
    """
    LedgerAccountsResponseV2Envelope
    """ # noqa: E501
    data: Optional[AccountPortfolioResponseV2] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AccountPortfolioResponseV2.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
