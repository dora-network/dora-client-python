...
class AffiliateMembershipListEnvelope(BaseModel):
    """
    AffiliateMembershipListEnvelope
    """ # noqa: E501
    data: List[AffiliateMembership]
    metadata: Metadata
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AffiliateMembership.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
