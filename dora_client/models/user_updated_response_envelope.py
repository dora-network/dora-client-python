...
class UserUpdatedResponseEnvelope(BaseModel):
    """
    UserUpdatedResponseEnvelope
    """ # noqa: E501
    data: Optional[CreateOrUpdateUserResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CreateOrUpdateUserResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
