...
class LockWithdrawalFeeRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    quote_token: StrictStr = Field(description="The signed quote token returned by GET /v1/web3/withdrawals/fee-quote. It must still be within its TTL and must have been issued for this withdrawal's destination, quantity, and chain.")
    __properties: ClassVar[List[str]] = ["quote_token"]
