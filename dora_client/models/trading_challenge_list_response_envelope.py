...
class TradingChallengeListResponseEnvelope(BaseModel):
    """
    TradingChallengeListResponseEnvelope
    """ # noqa: E501
    data: Optional[List[TradingChallenge]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TradingChallenge.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
