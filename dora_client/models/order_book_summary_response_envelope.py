...
class OrderBookSummaryResponseEnvelope(BaseModel):
    """
    OrderBookSummaryResponseEnvelope
    """ # noqa: E501
    data: Optional[OrderBookSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OrderBookSummary.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
