...
class AffiliateReferralReportEnvelope(BaseModel):
    """
    AffiliateReferralReportEnvelope
    """ # noqa: E501
    data: AffiliateReferralReport
    metadata: Metadata
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AffiliateReferralReport.from_dict(obj["data"]) if obj.get("data") is not None else None,
