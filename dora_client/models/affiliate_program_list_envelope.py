...
class AffiliateProgramListEnvelope(BaseModel):
    """
    AffiliateProgramListEnvelope
    """ # noqa: E501
    data: List[AffiliateProgram]
    metadata: Metadata
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AffiliateProgram.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
