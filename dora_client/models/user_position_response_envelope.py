...
class UserPositionResponseEnvelope(BaseModel):
    """
    UserPositionResponseEnvelope
    """ # noqa: E501
    data: Optional[PositionResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PositionResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
