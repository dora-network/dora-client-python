...
class CashReserveResponseEnvelope(BaseModel):
    """
    CashReserveResponseEnvelope
    """ # noqa: E501
    data: Optional[CashReserveResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CashReserveResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
