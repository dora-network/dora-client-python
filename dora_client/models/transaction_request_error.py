...
class TransactionRequestError(BaseModel):
    """
    TransactionRequestError
    """ # noqa: E501
    data: Optional[Dict[str, Any]] = Field(default=None, description="The response data. Present for successful (2xx) responses.")
