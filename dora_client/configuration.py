...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "apiKeyAuthQuery": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = dora_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://staging.dora.co" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("dora_client")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'apiKeyAuthQuery' in self.api_key:
