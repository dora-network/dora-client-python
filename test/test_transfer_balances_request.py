...
class TestTransferBalancesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransferBalancesRequest:
        """Test TransferBalancesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferBalancesRequest`
        """
        model = TransferBalancesRequest()
        if include_optional:
